...
namespace jasonmccallister\healthcheck\widgets;

use jasonmccallister\healthcheck\HealthCheck;
use jasonmccallister\healthcheck\assetbundles\healthcheckwidgetwidget\HealthCheckWidgetWidgetAsset;
...
class HealthCheckWidget extends Widget
{
    ...
    {
        return Craft::t('health-check', 'HealthCheckWidget');
    }
    ...
    {
        return Craft::getAlias("@jasonmccallister/healthcheck/assetbundles/healthcheckwidgetwidget/dist/img/HealthCheckWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'health-check/_components/widgets/HealthCheckWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(HealthCheckWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'health-check/_components/widgets/HealthCheckWidget_body',
            [
